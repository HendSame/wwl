...
<div class="container">
    ...
    <div class="weui_cells weui_cells_access">
        ...
        <a class="weui_cell" href="<?php  echo $this->createMobileUrl('userqrcode')?>" onclick="save_userinfo()">
            ...
            <div class="weui_cell_ft"><?php  if(!$info['user_qrcode']) { ?><span style="color:red">（尚未添加）</span><?php  } ?>添加/修改</div>
        </a>
    </div>
...
<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>/addons/sunshine_hireme/common/js/area.js"></script>
