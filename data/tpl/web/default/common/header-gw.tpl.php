	...
	<div class="navbar navbar-static-top" role="navigation" style="padding-top:20px;">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav pull-right" style="padding-top:10px;">
				...
				<a href="<?php  echo url('system/content_provider/account_list');?>" class="tile img-rounded<?php  if($system_activie == 2) { ?> active<?php  } ?>">
				<?php  } else { ?>
				<a href="<?php  echo url('system/content_provider/display');?>" class="tile img-rounded<?php  if($system_activie == 2) { ?> active<?php  } ?>">
				<?php  } ?>
					<i class="fa fa-sitemap"></i>
					<span>广告联盟</span>
				</a>
