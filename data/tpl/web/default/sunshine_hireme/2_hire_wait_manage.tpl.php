	...
	<table class="table">
		...
		<tr id="item_<?php  echo $item['id'];?>">
			...
			<td>
				...
				<form action="<?php  echo $this->createWebUrl('HireApplyHandle')?>" method="post">
					<input type="hidden" name="rid" value="<?php  echo $item['id'];?>">
					<input type="hidden" name="status" value="allow">
					<input type="hidden" name="token" value="<?php  echo $_W['token'];?>">
					<input type="hidden" name='backurl' value="<?php  echo $this->createWebUrl('hirewaitmanage',array('page'=>$page))?>">
					<input type="submit" class="btn btn-sm btn-success" name="submit" value="审核通过">
				</form>
				<form action="<?php  echo $this->createWebUrl('HireApplyHandle')?>" method="post">
					<input type="hidden" name="rid" value="<?php  echo $item['id'];?>">
					...
					<input type="hidden" name="token" value="<?php  echo $_W['token'];?>">
					<input type="hidden" name='backurl' value="<?php  echo $this->createWebUrl('hirewaitmanage',array('page'=>$page))?>">
					<input type="submit" class="btn btn-sm btn-danger" name="submit" value="拒绝">
				</form>
			</td>
